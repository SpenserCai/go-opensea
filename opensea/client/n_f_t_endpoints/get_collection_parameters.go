...
// WithCollectionSlug adds the collectionSlug to the get collection params
func (o *GetCollectionParams) WithCollectionSlug(collectionSlug string) *GetCollectionParams {
	o.SetCollectionSlug(collectionSlug)
	return o
}

// SetCollectionSlug adds the collectionSlug to the get collection params
func (o *GetCollectionParams) SetCollectionSlug(collectionSlug string) {
